...
export default function Page() {
    ...
    const previewContent: typeof form["values"] = localStorage.getItem(KEYS["TEMP_PREVIEW"]) ? JSON.parse(localStorage.getItem(KEYS["TEMP_PREVIEW"])!) : form.values;
    ...
    return (
        <>
            ...
            <div className='relative h-[280px] lg:h-[350px]'>
                {typeof previewContent.image === "string" && <Image
