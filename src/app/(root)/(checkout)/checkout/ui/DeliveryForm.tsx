  ...
  const form = useForm({
    initialValues: {
      shippingAddress: {
        ...
        addressLine1: currentUser?.shippingAddress?.addressLine1 ?? '',
      ...
      billingAddress: {
        ...
        addressLine1: currentUser?.billingAddress?.addressLine1 ?? '',
        addressLine2: currentUser?.billingAddress?.addressLine2 ?? '',
