...
export const Profile = ({ user }: Props) => {
  return (
    <div className='grid grid-cols-[114px_1fr] grid-rows-[56px_1fr_1fr_1fr] border-[1px] border-[#EEE] bg-white'>
      ...
      <>
        <p className='inline-flex items-center gap-2 border border-l-0 border-[#EEE] p-4 font-black uppercase text-[#787878]'>
          <Mail size={16} /> Email
        </p>
      ...
      {user.shippingAddress?.phoneNumber && (
        <>
          <p className='inline-flex items-center gap-2 border-r border-[#EEE] p-4 font-black uppercase text-[#787878]'>
