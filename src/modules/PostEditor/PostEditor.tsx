...
export const sharedProps = {
	toolbarBtn: {
		styles: { control: { height: "36px", backgroundColor: "transparent", border: 0, padding: 0, color: "black", strokeWidth: "2px" } },
		...
		<div className="w-full max-w-[700px] min-[2000px]:max-w-[60%] flex flex-col bg-white gap-12 p-4 lg:pb-8 rounded border border-[#C8C8C8]">
			<div>
				...
				<TextInput classNames={{
					input: cn(
						'form-input',
						form?.errors?.title && 'form-error--input'
					),
					root: 'form-root',
					label: 'form-label',
					error: 'form-error',
				...
				<div style={{ height: "95%", border: form.errors?.content ? '1px solid red' : '1px solid #C8C8C8', borderTopLeftRadius: 5, borderTopRightRadius: 5 }}>
					<RichTextEditor editor={editor} classNames={{
						...
						<RichTextEditor.Toolbar
							styles={{ toolbar: { backgroundColor: '#C8C8C8', gap: 0, padding: "0 0.5em" } }}
						>
